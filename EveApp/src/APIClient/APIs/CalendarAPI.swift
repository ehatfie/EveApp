...
open class CalendarAPI {
     ...
     */
    open class func getCharactersCharacterIdCalendar(characterId: Int, datasource: Datasource_getCharactersCharacterIdCalendar? = nil, fromEvent: Int? = nil, ifNoneMatch: String? = nil, token: String? = nil, completion: @escaping ((_ data: [GetCharactersCharacterIdCalendar200Ok]?,_ error: Error?) -> Void)) {
  ...
  "title" : "title"
     ...
     */
    open class func getCharactersCharacterIdCalendarWithRequestBuilder(characterId: Int, datasource: Datasource_getCharactersCharacterIdCalendar? = nil, fromEvent: Int? = nil, ifNoneMatch: String? = nil, token: String? = nil) -> RequestBuilder<[GetCharactersCharacterIdCalendar200Ok]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCharactersCharacterIdCalendarEventId(characterId: Int, eventId: Int, datasource: Datasource_getCharactersCharacterIdCalendarEventId? = nil, ifNoneMatch: String? = nil, token: String? = nil, completion: @escaping ((_ data: GetCharactersCharacterIdCalendarEventIdOk?,_ error: Error?) -> Void)) {
  ...
  "owner_type" : "eve_server"
     ...
     */
    open class func getCharactersCharacterIdCalendarEventIdWithRequestBuilder(characterId: Int, eventId: Int, datasource: Datasource_getCharactersCharacterIdCalendarEventId? = nil, ifNoneMatch: String? = nil, token: String? = nil) -> RequestBuilder<GetCharactersCharacterIdCalendarEventIdOk> {
  ...
  "character_id" : 0
     ...
     */
    open class func getCharactersCharacterIdCalendarEventIdAttendeesWithRequestBuilder(characterId: Int, eventId: Int, datasource: Datasource_getCharactersCharacterIdCalendarEventIdAttendees? = nil, ifNoneMatch: String? = nil, token: String? = nil) -> RequestBuilder<[GetCharactersCharacterIdCalendarEventIdAttendees200Ok]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func putCharactersCharacterIdCalendarEventId(body: PutCharactersCharacterIdCalendarEventIdResponse, characterId: Int, eventId: Int, datasource: Datasource_putCharactersCharacterIdCalendarEventId? = nil, token: String? = nil, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
     ...
     */
    open class func putCharactersCharacterIdCalendarEventIdWithRequestBuilder(body: PutCharactersCharacterIdCalendarEventIdResponse, characterId: Int, eventId: Int, datasource: Datasource_putCharactersCharacterIdCalendarEventId? = nil, token: String? = nil) -> RequestBuilder<Void> {
        var path = "/v3/characters/{character_id}/calendar/{event_id}/"
        let characterIdPreEscape = "\(characterId)"
        let characterIdPostEscape = characterIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{character_id}", with: characterIdPostEscape, options: .literal, range: nil)
