...
open class ClonesAPI {
     ...
     */
    open class func getCharactersCharacterIdClones(characterId: Int, datasource: Datasource_getCharactersCharacterIdClones? = nil, ifNoneMatch: String? = nil, token: String? = nil, completion: @escaping ((_ data: GetCharactersCharacterIdClonesOk?,_ error: Error?) -> Void)) {
  ...
  "home_location" : {
     ...
     */
    open class func getCharactersCharacterIdClonesWithRequestBuilder(characterId: Int, datasource: Datasource_getCharactersCharacterIdClones? = nil, ifNoneMatch: String? = nil, token: String? = nil) -> RequestBuilder<GetCharactersCharacterIdClonesOk> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCharactersCharacterIdImplants(characterId: Int, datasource: Datasource_getCharactersCharacterIdImplants? = nil, ifNoneMatch: String? = nil, token: String? = nil, completion: @escaping ((_ data: [Int]?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getCharactersCharacterIdImplantsWithRequestBuilder(characterId: Int, datasource: Datasource_getCharactersCharacterIdImplants? = nil, ifNoneMatch: String? = nil, token: String? = nil) -> RequestBuilder<[Int]> {
