...
open class InsuranceAPI {
     ...
     */
    open class func getInsurancePrices(acceptLanguage: AcceptLanguage_getInsurancePrices? = nil, datasource: Datasource_getInsurancePrices? = nil, ifNoneMatch: String? = nil, language: Language_getInsurancePrices? = nil, completion: @escaping ((_ data: [GetInsurancePrices200Ok]?,_ error: Error?) -> Void)) {
  ...
  "levels" : [ {
     ...
     */
    open class func getInsurancePricesWithRequestBuilder(acceptLanguage: AcceptLanguage_getInsurancePrices? = nil, datasource: Datasource_getInsurancePrices? = nil, ifNoneMatch: String? = nil, language: Language_getInsurancePrices? = nil) -> RequestBuilder<[GetInsurancePrices200Ok]> {
