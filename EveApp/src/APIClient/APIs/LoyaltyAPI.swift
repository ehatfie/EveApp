...
open class LoyaltyAPI {
     ...
     */
    open class func getCharactersCharacterIdLoyaltyPoints(characterId: Int, datasource: Datasource_getCharactersCharacterIdLoyaltyPoints? = nil, ifNoneMatch: String? = nil, token: String? = nil, completion: @escaping ((_ data: [GetCharactersCharacterIdLoyaltyPoints200Ok]?,_ error: Error?) -> Void)) {
  ...
  "loyalty_points" : 6
     ...
     */
    open class func getCharactersCharacterIdLoyaltyPointsWithRequestBuilder(characterId: Int, datasource: Datasource_getCharactersCharacterIdLoyaltyPoints? = nil, ifNoneMatch: String? = nil, token: String? = nil) -> RequestBuilder<[GetCharactersCharacterIdLoyaltyPoints200Ok]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getLoyaltyStoresCorporationIdOffers(corporationId: Int, datasource: Datasource_getLoyaltyStoresCorporationIdOffers? = nil, ifNoneMatch: String? = nil, completion: @escaping ((_ data: [GetLoyaltyStoresCorporationIdOffers200Ok]?,_ error: Error?) -> Void)) {
  ...
  "required_items" : [ {
     ...
     */
    open class func getLoyaltyStoresCorporationIdOffersWithRequestBuilder(corporationId: Int, datasource: Datasource_getLoyaltyStoresCorporationIdOffers? = nil, ifNoneMatch: String? = nil) -> RequestBuilder<[GetLoyaltyStoresCorporationIdOffers200Ok]> {
