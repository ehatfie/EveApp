...
open class RoutesAPI {
     ...
     */
    open class func getRouteOriginDestination(destination: Int, origin: Int, avoid: [Int]? = nil, connections: [[Int]]? = nil, datasource: Datasource_getRouteOriginDestination? = nil, flag: Flag_getRouteOriginDestination? = nil, ifNoneMatch: String? = nil, completion: @escaping ((_ data: [Int]?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getRouteOriginDestinationWithRequestBuilder(destination: Int, origin: Int, avoid: [Int]? = nil, connections: [[Int]]? = nil, datasource: Datasource_getRouteOriginDestination? = nil, flag: Flag_getRouteOriginDestination? = nil, ifNoneMatch: String? = nil) -> RequestBuilder<[Int]> {
