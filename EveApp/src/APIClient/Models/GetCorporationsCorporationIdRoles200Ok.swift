...
public struct GetCorporationsCorporationIdRoles200Ok: Codable {
    ...
    public init(characterId: Int, grantableRoles: [GrantableRoles]? = nil, grantableRolesAtBase: [GrantableRolesAtBase]? = nil, grantableRolesAtHq: [GrantableRolesAtHq]? = nil, grantableRolesAtOther: [GrantableRolesAtOther]? = nil, roles: [Roles]? = nil, rolesAtBase: [RolesAtBase]? = nil, rolesAtHq: [RolesAtHq]? = nil, rolesAtOther: [RolesAtOther]? = nil) {
