...
extension IndyTool {
  func makeDisplayableJobsForInputSums(inputs: [Int64: Int64], assets: [Int64: Int64]) async -> [DisplayableJob] {
    let jobs = await makeJobsForInputSums(inputs: inputs, assets: assets)
  ...
  func makeJobsForInputSums(inputs: [Int64: Int64], assets: [Int64: Int64]) async -> [TestJob] {
    ...
    let missingInputIds = Set(inputMaterialIds).subtracting(assetIds)
