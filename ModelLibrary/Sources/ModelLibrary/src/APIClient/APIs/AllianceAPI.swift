...
@MainActor open class AllianceAPI {
    /**
     ...
     */
    @MainActor open class func getAlliances(datasource: Datasource_getAlliances? = nil, ifNoneMatch: String? = nil, completion: @escaping ((_ data: [Int]?,_ error: Error?) -> Void)) {
     ...
     */
    @MainActor open class func getAlliancesWithRequestBuilder(datasource: Datasource_getAlliances? = nil, ifNoneMatch: String? = nil) -> RequestBuilder<[Int]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    @MainActor open class func getAlliancesAllianceId(allianceId: Int, datasource: Datasource_getAlliancesAllianceId? = nil, ifNoneMatch: String? = nil, completion: @escaping ((_ data: GetAlliancesAllianceIdOk?,_ error: Error?) -> Void)) {
  ...
  "executor_corporation_id" : 1
     ...
     */
    @MainActor open class func getAlliancesAllianceIdWithRequestBuilder(allianceId: Int, datasource: Datasource_getAlliancesAllianceId? = nil, ifNoneMatch: String? = nil) -> RequestBuilder<GetAlliancesAllianceIdOk> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    @MainActor open class func getAlliancesAllianceIdCorporations(allianceId: Int, datasource: Datasource_getAlliancesAllianceIdCorporations? = nil, ifNoneMatch: String? = nil, completion: @escaping ((_ data: [Int]?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<[Int]> 
     */
    @MainActor open class func getAlliancesAllianceIdCorporationsWithRequestBuilder(allianceId: Int, datasource: Datasource_getAlliancesAllianceIdCorporations? = nil, ifNoneMatch: String? = nil) -> RequestBuilder<[Int]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    @MainActor open class func getAlliancesAllianceIdIcons(allianceId: Int, datasource: Datasource_getAlliancesAllianceIdIcons? = nil, ifNoneMatch: String? = nil, completion: @escaping ((_ data: GetAlliancesAllianceIdIconsOk?,_ error: Error?) -> Void)) {
  ...
  "px128x128" : "px128x128"
     ...
     */
    @MainActor open class func getAlliancesAllianceIdIconsWithRequestBuilder(allianceId: Int, datasource: Datasource_getAlliancesAllianceIdIcons? = nil, ifNoneMatch: String? = nil) -> RequestBuilder<GetAlliancesAllianceIdIconsOk> {
