//
// GetCorporationsCorporationIdOrders200Ok.swift
//
...
public struct GetCorporationsCorporationIdOrders200Ok: Codable {
    ...
    public init(duration: Int, escrow: Double? = nil, isBuyOrder: Bool? = nil, issued: Date, issuedBy: Int, locationId: Int64, minVolume: Int? = nil, orderId: Int64, price: Double, range: ModelRange, regionId: Int, typeId: Int, volumeRemain: Int, volumeTotal: Int, walletDivision: Int) {
