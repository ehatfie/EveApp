//
// GetCorporationsCorporationIdRolesHistory200Ok.swift
//
...
public struct GetCorporationsCorporationIdRolesHistory200Ok: Codable {

    public enum NewRoles: String, Codable { 
    ...
    public enum OldRoles: String, Codable { 
        case accountTake1 = "Account_Take_1"
        case accountTake2 = "Account_Take_2"
        case accountTake3 = "Account_Take_3"
        case accountTake4 = "Account_Take_4"
    ...
    /** new_roles array */
    public var newRoles: [NewRoles]
    /** old_roles array */
    public var oldRoles: [OldRoles]
    /** role_type string */
    public var roleType: RoleType

    public init(changedAt: Date, characterId: Int, issuerId: Int, newRoles: [NewRoles], oldRoles: [OldRoles], roleType: RoleType) {
