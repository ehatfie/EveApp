//
// GetMarketsStructuresStructureId200Ok.swift
//
...
public struct GetMarketsStructuresStructureId200Ok: Codable {
    ...
    public init(duration: Int, isBuyOrder: Bool, issued: Date, locationId: Int64, minVolume: Int, orderId: Int64, price: Double, range: ModelRange, typeId: Int, volumeRemain: Int, volumeTotal: Int) {
