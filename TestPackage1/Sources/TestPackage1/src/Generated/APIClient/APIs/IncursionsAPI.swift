...
open class IncursionsAPI {
     ...
     */
    open class func getIncursions(datasource: Datasource_getIncursions? = nil, ifNoneMatch: String? = nil, completion: @escaping ((_ data: [GetIncursions200Ok]?,_ error: Error?) -> Void)) {
  ...
  "influence" : 5.962134
     ...
     */
    open class func getIncursionsWithRequestBuilder(datasource: Datasource_getIncursions? = nil, ifNoneMatch: String? = nil) -> RequestBuilder<[GetIncursions200Ok]> {
