...
open class KillmailsAPI {
     ...
     */
    open class func getCharactersCharacterIdKillmailsRecent(characterId: Int, datasource: Datasource_getCharactersCharacterIdKillmailsRecent? = nil, ifNoneMatch: String? = nil, page: Int? = nil, token: String? = nil, completion: @escaping ((_ data: [GetCharactersCharacterIdKillmailsRecent200Ok]?,_ error: Error?) -> Void)) {
  ...
  "killmail_id" : 0
     ...
     */
    open class func getCharactersCharacterIdKillmailsRecentWithRequestBuilder(characterId: Int, datasource: Datasource_getCharactersCharacterIdKillmailsRecent? = nil, ifNoneMatch: String? = nil, page: Int? = nil, token: String? = nil) -> RequestBuilder<[GetCharactersCharacterIdKillmailsRecent200Ok]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCorporationsCorporationIdKillmailsRecent(corporationId: Int, datasource: Datasource_getCorporationsCorporationIdKillmailsRecent? = nil, ifNoneMatch: String? = nil, page: Int? = nil, token: String? = nil, completion: @escaping ((_ data: [GetCorporationsCorporationIdKillmailsRecent200Ok]?,_ error: Error?) -> Void)) {
  ...
  "killmail_id" : 0
     ...
     */
    open class func getCorporationsCorporationIdKillmailsRecentWithRequestBuilder(corporationId: Int, datasource: Datasource_getCorporationsCorporationIdKillmailsRecent? = nil, ifNoneMatch: String? = nil, page: Int? = nil, token: String? = nil) -> RequestBuilder<[GetCorporationsCorporationIdKillmailsRecent200Ok]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getKillmailsKillmailIdKillmailHash(killmailHash: String, killmailId: Int, datasource: Datasource_getKillmailsKillmailIdKillmailHash? = nil, ifNoneMatch: String? = nil, completion: @escaping ((_ data: GetKillmailsKillmailIdKillmailHashOk?,_ error: Error?) -> Void)) {
  ...
  "war_id" : 6
     ...
     */
    open class func getKillmailsKillmailIdKillmailHashWithRequestBuilder(killmailHash: String, killmailId: Int, datasource: Datasource_getKillmailsKillmailIdKillmailHash? = nil, ifNoneMatch: String? = nil) -> RequestBuilder<GetKillmailsKillmailIdKillmailHashOk> {
