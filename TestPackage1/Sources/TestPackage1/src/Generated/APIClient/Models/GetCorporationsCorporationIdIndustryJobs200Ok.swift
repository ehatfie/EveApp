//
// GetCorporationsCorporationIdIndustryJobs200Ok.swift
//
...
public struct GetCorporationsCorporationIdIndustryJobs200Ok: Codable {
    ...
    public init(activityId: Int, blueprintId: Int64, blueprintLocationId: Int64, blueprintTypeId: Int, completedCharacterId: Int? = nil, completedDate: Date? = nil, cost: Double? = nil, duration: Int, endDate: Date, facilityId: Int64, installerId: Int, jobId: Int, licensedRuns: Int? = nil, locationId: Int64, outputLocationId: Int64, pauseDate: Date? = nil, probability: Float? = nil, productTypeId: Int? = nil, runs: Int, startDate: Date, status: Status, successfulRuns: Int? = nil) {
