...
@MainActor open class FittingsAPI {
    /**
     ...
     */
    @MainActor open class func deleteCharactersCharacterIdFittingsFittingId(characterId: Int, fittingId: Int, datasource: Datasource_deleteCharactersCharacterIdFittingsFittingId? = nil, token: String? = nil, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
     ...
     */
    @MainActor open class func deleteCharactersCharacterIdFittingsFittingIdWithRequestBuilder(characterId: Int, fittingId: Int, datasource: Datasource_deleteCharactersCharacterIdFittingsFittingId? = nil, token: String? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    @MainActor open class func getCharactersCharacterIdFittings(characterId: Int, datasource: Datasource_getCharactersCharacterIdFittings? = nil, ifNoneMatch: String? = nil, token: String? = nil, completion: @escaping ((_ data: [GetCharactersCharacterIdFittings200Ok]?,_ error: Error?) -> Void)) {
  ...
  "items" : [ {
     ...
     */
    @MainActor open class func getCharactersCharacterIdFittingsWithRequestBuilder(characterId: Int, datasource: Datasource_getCharactersCharacterIdFittings? = nil, ifNoneMatch: String? = nil, token: String? = nil) -> RequestBuilder<[GetCharactersCharacterIdFittings200Ok]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    @MainActor open class func postCharactersCharacterIdFittings(body: PostCharactersCharacterIdFittingsFitting, characterId: Int, datasource: Datasource_postCharactersCharacterIdFittings? = nil, token: String? = nil, completion: @escaping ((_ data: PostCharactersCharacterIdFittingsCreated?,_ error: Error?) -> Void)) {
  ...
  "fitting_id" : 0
     ...
     */
    @MainActor open class func postCharactersCharacterIdFittingsWithRequestBuilder(body: PostCharactersCharacterIdFittingsFitting, characterId: Int, datasource: Datasource_postCharactersCharacterIdFittings? = nil, token: String? = nil) -> RequestBuilder<PostCharactersCharacterIdFittingsCreated> {
        var path = "/v2/characters/{character_id}/fittings/"
        let characterIdPreEscape = "\(characterId)"
        let characterIdPostEscape = characterIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{character_id}", with: characterIdPostEscape, options: .literal, range: nil)
