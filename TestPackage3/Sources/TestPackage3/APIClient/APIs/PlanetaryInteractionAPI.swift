...
@MainActor open class PlanetaryInteractionAPI {
    /**
     ...
     */
    @MainActor open class func getCharactersCharacterIdPlanets(characterId: Int, datasource: Datasource_getCharactersCharacterIdPlanets? = nil, ifNoneMatch: String? = nil, token: String? = nil, completion: @escaping ((_ data: [GetCharactersCharacterIdPlanets200Ok]?,_ error: Error?) -> Void)) {
  ...
  "num_pins" : 1
     ...
     */
    @MainActor open class func getCharactersCharacterIdPlanetsWithRequestBuilder(characterId: Int, datasource: Datasource_getCharactersCharacterIdPlanets? = nil, ifNoneMatch: String? = nil, token: String? = nil) -> RequestBuilder<[GetCharactersCharacterIdPlanets200Ok]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    @MainActor open class func getCharactersCharacterIdPlanetsPlanetId(characterId: Int, planetId: Int, datasource: Datasource_getCharactersCharacterIdPlanetsPlanetId? = nil, token: String? = nil, completion: @escaping ((_ data: GetCharactersCharacterIdPlanetsPlanetIdOk?,_ error: Error?) -> Void)) {
  ...
  "pins" : [ {
     ...
     */
    @MainActor open class func getCharactersCharacterIdPlanetsPlanetIdWithRequestBuilder(characterId: Int, planetId: Int, datasource: Datasource_getCharactersCharacterIdPlanetsPlanetId? = nil, token: String? = nil) -> RequestBuilder<GetCharactersCharacterIdPlanetsPlanetIdOk> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    @MainActor open class func getCorporationsCorporationIdCustomsOffices(corporationId: Int, datasource: Datasource_getCorporationsCorporationIdCustomsOffices? = nil, ifNoneMatch: String? = nil, page: Int? = nil, token: String? = nil, completion: @escaping ((_ data: [GetCorporationsCorporationIdCustomsOffices200Ok]?,_ error: Error?) -> Void)) {
  ...
  "allow_alliance_access" : true
     ...
     */
    @MainActor open class func getCorporationsCorporationIdCustomsOfficesWithRequestBuilder(corporationId: Int, datasource: Datasource_getCorporationsCorporationIdCustomsOffices? = nil, ifNoneMatch: String? = nil, page: Int? = nil, token: String? = nil) -> RequestBuilder<[GetCorporationsCorporationIdCustomsOffices200Ok]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    @MainActor open class func getUniverseSchematicsSchematicId(schematicId: Int, datasource: Datasource_getUniverseSchematicsSchematicId? = nil, ifNoneMatch: String? = nil, completion: @escaping ((_ data: GetUniverseSchematicsSchematicIdOk?,_ error: Error?) -> Void)) {
  ...
  "cycle_time" : 0
     ...
     */
    @MainActor open class func getUniverseSchematicsSchematicIdWithRequestBuilder(schematicId: Int, datasource: Datasource_getUniverseSchematicsSchematicId? = nil, ifNoneMatch: String? = nil) -> RequestBuilder<GetUniverseSchematicsSchematicIdOk> {
