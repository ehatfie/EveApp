...
@MainActor open class UserInterfaceAPI {
    /**
     ...
     */
    @MainActor open class func postUiAutopilotWaypoint(addToBeginning: Bool, clearOtherWaypoints: Bool, destinationId: Int64, datasource: Datasource_postUiAutopilotWaypoint? = nil, token: String? = nil, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
     ...
     */
    @MainActor open class func postUiAutopilotWaypointWithRequestBuilder(addToBeginning: Bool, clearOtherWaypoints: Bool, destinationId: Int64, datasource: Datasource_postUiAutopilotWaypoint? = nil, token: String? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    @MainActor open class func postUiOpenwindowContract(contractId: Int, datasource: Datasource_postUiOpenwindowContract? = nil, token: String? = nil, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    @MainActor open class func postUiOpenwindowContractWithRequestBuilder(contractId: Int, datasource: Datasource_postUiOpenwindowContract? = nil, token: String? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    @MainActor open class func postUiOpenwindowInformation(targetId: Int, datasource: Datasource_postUiOpenwindowInformation? = nil, token: String? = nil, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    @MainActor open class func postUiOpenwindowInformationWithRequestBuilder(targetId: Int, datasource: Datasource_postUiOpenwindowInformation? = nil, token: String? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    @MainActor open class func postUiOpenwindowMarketdetails(typeId: Int, datasource: Datasource_postUiOpenwindowMarketdetails? = nil, token: String? = nil, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    @MainActor open class func postUiOpenwindowMarketdetailsWithRequestBuilder(typeId: Int, datasource: Datasource_postUiOpenwindowMarketdetails? = nil, token: String? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    @MainActor open class func postUiOpenwindowNewmail(body: PostUiOpenwindowNewmailNewMail, datasource: Datasource_postUiOpenwindowNewmail? = nil, token: String? = nil, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    @MainActor open class func postUiOpenwindowNewmailWithRequestBuilder(body: PostUiOpenwindowNewmailNewMail, datasource: Datasource_postUiOpenwindowNewmail? = nil, token: String? = nil) -> RequestBuilder<Void> {
