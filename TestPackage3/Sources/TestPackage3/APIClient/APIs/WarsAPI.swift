...
@MainActor open class WarsAPI {
     ...
     */
    @MainActor open class func getWars(datasource: Datasource_getWars? = nil, ifNoneMatch: String? = nil, maxWarId: Int? = nil, completion: @escaping ((_ data: [Int]?,_ error: Error?) -> Void)) {
     ...
     */
    @MainActor open class func getWarsWithRequestBuilder(datasource: Datasource_getWars? = nil, ifNoneMatch: String? = nil, maxWarId: Int? = nil) -> RequestBuilder<[Int]> {
        let path = "/v1/wars/"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    @MainActor open class func getWarsWarId(warId: Int, datasource: Datasource_getWarsWarId? = nil, ifNoneMatch: String? = nil, completion: @escaping ((_ data: GetWarsWarIdOk?,_ error: Error?) -> Void)) {
  ...
  "defender" : {
     ...
     */
    @MainActor open class func getWarsWarIdWithRequestBuilder(warId: Int, datasource: Datasource_getWarsWarId? = nil, ifNoneMatch: String? = nil) -> RequestBuilder<GetWarsWarIdOk> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    @MainActor open class func getWarsWarIdKillmails(warId: Int, datasource: Datasource_getWarsWarIdKillmails? = nil, ifNoneMatch: String? = nil, page: Int? = nil, completion: @escaping ((_ data: [GetWarsWarIdKillmails200Ok]?,_ error: Error?) -> Void)) {
  ...
  "killmail_id" : 0
     ...
     */
    @MainActor open class func getWarsWarIdKillmailsWithRequestBuilder(warId: Int, datasource: Datasource_getWarsWarIdKillmails? = nil, ifNoneMatch: String? = nil, page: Int? = nil) -> RequestBuilder<[GetWarsWarIdKillmails200Ok]> {
