...
nonisolated(unsafe) private var managerStore: [String: Alamofire.SessionManager] = [:]
...
@MainActor open class AlamofireRequestBuilder<T>: RequestBuilder<T> {
    ...
    override open func execute(_ completion: @escaping (_ response: Response<T>?, _ error: Error?) -> Void) {
        ...
        nonisolated(unsafe) let manager = createSessionManager()
        Task {
            managerStore[managerId] = manager
//            syncQueue.async(flags: .barrier) { [weak manager] in
...
@MainActor open class AlamofireDecodableRequestBuilder<T:Decodable>: AlamofireRequestBuilder<T> {
