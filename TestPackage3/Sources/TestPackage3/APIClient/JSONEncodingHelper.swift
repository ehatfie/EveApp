...
@MainActor open class JSONEncodingHelper {

    @MainActor open class func encodingParameters<T:Encodable>(forEncodableObject encodableObj: T?) -> Parameters? {
    ...
    @MainActor open class func encodingParameters(forEncodableObject encodableObj: Any?) -> Parameters? {
        var params: Parameters? = nil
