//
// GetCharactersCharacterIdOrders200Ok.swift
//
...
public struct GetCharactersCharacterIdOrders200Ok: Codable {
    ...
    public init(duration: Int, escrow: Double? = nil, isBuyOrder: Bool? = nil, isCorporation: Bool, issued: Date, locationId: Int64, minVolume: Int? = nil, orderId: Int64, price: Double, range: ModelRange, regionId: Int, typeId: Int, volumeRemain: Int, volumeTotal: Int) {
